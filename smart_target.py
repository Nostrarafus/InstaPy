...
# login credentials
insta_username = 'esports_merchandising'
insta_password = 'Esportsmkt11_inst'
...
"""
targets = ['elrubiuswtf', 'grefg_official', 'fnatic']
...
# COMMENT data
comments = ['Check our last collection! @{}',
        'I love your profile! @{}',
...
with smart_run(session):
    ...
    session.set_do_comment(enabled=False, percentage=15)
